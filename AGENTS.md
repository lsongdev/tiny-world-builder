...
- Current skill routing:
  ...
  - `.codex/skills/tinyworld-mesh-terrain` — opt-in voxel-mesh landscape sculptor (paint per-voxel materials + pull/push-sculpt, then bake into world terrain). Module `engine/world/46-mesh-terrain.js`.
