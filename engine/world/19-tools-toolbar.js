  ...
  const TOOLS = [
    ...
    { id: 'pig',    label: 'Pig',    kind: 'pig',   color: '#f2a9b8', group: 'animals' },
  ...
  function makeThumbObject(tool) {
    ...
    if (k === 'pig')       return makeVoxelAnimal('pig');
  ...
  function stampBuilderAllTools() {
    ...
    const ids = [
      ...
      'tuft', 'flower', 'bush', 'cow', 'sheep', 'pig',
    ];
    for (const id of ids) {
  ...
  const TOOL_GLYPH_SVG = {
    ...
    "pig": "<svg viewBox=\"0 0 512 512\"><g fill=\"currentColor\"><rect x=\"185\" y=\"185\" width=\"270\" height=\"165\" rx=\"68\"/><circle cx=\"150\" cy=\"228\" r=\"92\"/><ellipse cx=\"62\" cy=\"248\" rx=\"48\" ry=\"36\"/><path d=\"M168 148 L118 58 L212 118 Z\"/><rect x=\"215\" y=\"330\" width=\"34\" height=\"95\" rx=\"12\"/><rect x=\"295\" y=\"330\" width=\"34\" height=\"95\" rx=\"12\"/><rect x=\"370\" y=\"330\" width=\"34\" height=\"95\" rx=\"12\"/><rect x=\"420\" y=\"325\" width=\"34\" height=\"95\" rx=\"12\"/><path d=\"M448 210c26-14 52 4 46 30c-5 22-30 30-48 18c10 3 23-3 27-15c5-14-6-26-21-23c-2 1-3-6-4-10z\"/></g></svg>",
