  ...
  function setupRenderSettings() {
    ...
    function resetRenderingSettings() {
      ...
      renderBrightness = parseFloat(RENDER_DEFAULTS.brightness);
      renderLighting = parseFloat(RENDER_DEFAULTS.lighting);
      renderAmbientFill = parseFloat(RENDER_DEFAULTS.ambientFill);
      renderFrontFill = parseFloat(RENDER_DEFAULTS.frontFill);
      renderSideFill = parseFloat(RENDER_DEFAULTS.sideFill);
      renderBackFill = parseFloat(RENDER_DEFAULTS.backFill);
      applyLightingSettings();
      renderSaturation = parseFloat(RENDER_DEFAULTS.saturation);
      renderContrast = parseFloat(RENDER_DEFAULTS.contrast);
      renderPixelSize = 1;
